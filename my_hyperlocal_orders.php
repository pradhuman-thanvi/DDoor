...
$stmt = $conn->prepare("SELECT * FROM hyperlocal WHERE username = ? ORDER BY id DESC");
...
<br>
    <div class="container">
        <h1>My Orders HyperLocal</h1>

        <?php if (!empty($orders)) : ?>
            <?php foreach ($orders as $order) : ?>
                <div class="ticket">
                    <div class="ticket-header">
                        Order #DD-PH-HY-<?php echo $order['id']; ?>
                    </div>
                    <div class="ticket-body">
                        ...
                        <div class="row">
                            <div class="col-6"><strong>Receiver Name:</strong> <?php echo htmlspecialchars($order['receiver_name']); ?></div>
                            <div class="col-6"><strong>Receiver Phone:</strong> <?php echo htmlspecialchars($order['receiver_phone']); ?></div>
                        </div>
                        <div class="row">
                            <div class="col-6"><strong>Payment:</strong> <?php echo htmlspecialchars($order['payment']); ?></div>
                            <div class="col-6"><strong>Status:</strong> <?php echo htmlspecialchars($order['status']); ?></div>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else : ?>
            <div class="alert alert-warning" role="alert">You have no orders.</div>
        <?php endif; ?>
    </div>
        ...
        <ul class="navbar-nav nav-justified w-100">
            ...
            <li class="nav-item">
                <a href="maintenance.html" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" class="navicon3" height="34px" viewBox="0 -960 960 960" width="34px" fill="#5f6368">
